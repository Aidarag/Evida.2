...
export default function LandingPage({
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Click any 'Get Started' button to register your account. We are currently in private beta and will notify you as soon as access opens for your campus."
    },
    {
