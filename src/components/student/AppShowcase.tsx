...
export default function AppShowcase() {
  ...
  return (
    <section className="w-full py-24 bg-[#FFFDF8] border-t border-black/[0.04] font-sans overflow-hidden" id="app-showcase">
      <div className="max-w-6xl mx-auto px-6 md:px-12 flex flex-col lg:flex-row gap-16 items-center">
                  ...
                  return (
                    <div key={idx} className="flex gap-4 items-start group">
                      ...
                      <div className="space-y-1.5">
                        <h4 className="text-sm font-bold text-[#121212] uppercase tracking-wide" style={{ fontFamily: 'var(--font-display)' }}>
                          {pt.name}
                        </h4>
        ...
        <div className="w-full lg:w-1/2 flex justify-center relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#FF5A1F]/5 rounded-full blur-[100px] pointer-events-none" />

          {/* iPhone body */}
          <div className="relative w-[300px] h-[610px] rounded-[50px] border-[9px] border-[#27272A] bg-[#121212] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.35)] overflow-hidden flex flex-col select-none ring-1 ring-white/10">
              ...
              <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="mt-4 bg-white/[0.07] backdrop-blur-xl border border-white/10 rounded-full py-2 px-3 flex items-center justify-between shadow-2xl z-30">
                      <div className="h-8 w-8 rounded-full bg-white/10 flex items-center justify-center cursor-pointer text-white">
                        <span className="h-1.5 w-1.5 rounded-full bg-[#FF5A1F]"></span>
                      </div>
                ...
                {activeTab === 'creation' && (
                  ...
                  >
                    {/* Header */}
                    <div>
                      <span className="text-[#FF5A1F] text-[9px] font-bold uppercase tracking-[0.2em] block mb-1">
                        Evida Wizard
                      </span>
                        ...
                        return (
                          <div 
                            ...
                            className={`p-3 rounded-2xl border flex flex-col items-center justify-center text-center gap-2 h-20 transition-all cursor-pointer ${
                              cell.active 
                                ? 'bg-white/15 border-[#FF5A1F] shadow-[0_4px_12px_rgba(255,90,31,0.1)]' 
                                : 'bg-white/[0.04] border-white/5 hover:border-white/15'
                            }`}
                          >
                            <Icon className={`h-4.5 w-4.5 ${cell.active ? 'text-[#FF5A1F]' : 'text-white/60'}`} />
                    ...
                    <button
                      onClick={() => setActiveTab('approval')}
                      className="w-full py-3 bg-white text-[#121212] rounded-full text-[10px] font-bold uppercase tracking-widest shadow-lg shadow-white/5 hover:scale-[1.02] transition-transform active:scale-[0.98] cursor-pointer text-center"
                      style={{ fontFamily: 'var(--font-display)' }}
                    >
                      Get Started
                    </button>
                ...
                {activeTab === 'approval' && (
                  ...
                  >
                      ...
                      {[
                        ...
                        <div 
                          ...
                          className={`p-3.5 rounded-2xl border text-left flex gap-3 items-center ${
                            step.status === 'done'
                              ...
                              : step.status === 'pulse'
                              ? 'bg-[#FF5A1F]/10 border-[#FF5A1F]/30 animate-pulse'
                        ...
                        >
                          {step.status === 'done' ? (
                            ...
                            <Brain className="h-5 w-5 text-[#FF5A1F] shrink-0" />
                          ) : (
                    ...
                    <button
                      ...
                      className="w-full py-3 bg-[#FF5A1F] hover:bg-[#e04b12] text-white rounded-full text-[10px] font-bold uppercase tracking-widest shadow-lg shadow-orange-500/10 hover:scale-[1.02] transition-transform active:scale-[0.98] cursor-pointer text-center"
                      style={{ fontFamily: 'var(--font-display)' }}
                    >
                      Reset Simulator
                    </button>
          ...
          <div className="absolute -bottom-6 flex items-center gap-1.5 text-[9px] font-bold text-gray-400 uppercase tracking-widest pointer-events-none select-none">
            <span className="h-1.5 w-1.5 rounded-full bg-[#FF5A1F] animate-ping"></span>
