        ...
        <div className="p-6 md:p-8 space-y-6 max-h-[85vh] overflow-y-auto">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Created by <span className="font-semibold text-[#5A554E]">{event.organizer}</span>
            </p>
          </div>

          {/* Event description */}
          <div className="space-y-2">
            <h4 className="text-xs font-bold text-[#5A554E] uppercase tracking-wider">About the Event</h4>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="flex items-start gap-3 rounded-xl bg-slate-900/50 p-3 border border-white/5">
              ...
              <div>
                ...
                <p className="text-xs text-[#5A554E]">{event.time}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-900/50 p-3 border border-white/5">
              ...
              <div>
                ...
                <p className="text-xs text-[#5A554E] capitalize">{event.locationType} Event</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {/* Going List */}
            <div className="space-y-2">
              <h4 className="text-xs font-bold text-[#5A554E] uppercase tracking-wider flex items-center gap-1.5">
            ...
            <div className="pt-4 border-t border-white/5">
              {event.status === 'pending' ? (
                ...
                <div className="rounded-xl bg-rose-500/5 border border-rose-500/20 p-4 text-xs text-rose-300/90 space-y-1.5">
                  ...
                  {event.feedback && (
                    <div className="mt-1 p-2 rounded bg-slate-900/60 border border-white/5 font-mono text-[11px] text-[#5A554E]">
