      ...
      <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-white/10 bg-slate-950 text-slate-100 shadow-2xl transition-all">
        ...
        <form onSubmit={handleFormSubmit} className="p-6 md:p-8 space-y-5 max-h-[85vh] overflow-y-auto">
          <div>
            ...
            <p className="mt-1.5 text-xs text-[#5A554E]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#5A554E] uppercase tracking-wide">Event Title *</label>
              <input
                type="text"
                required
                value={title}
            ...
            {/* Ownership */}
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#5A554E] uppercase tracking-wide">Who is organizing? *</label>
              <select
                value={ownershipType}
          ...
          {ownershipType === 'organization' && userOrgs.length > 0 && (
            <div className="space-y-1.5 rounded-xl border border-dashed border-white/10 bg-slate-900/20 p-3.5">
              <label className="text-xs font-bold text-[#5A554E] uppercase tracking-wide flex items-center gap-1.5">
          ...
          {/* Description */}
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-[#5A554E] uppercase tracking-wide">Description & Details *</label>
            <textarea
              required
              rows={3}
              value={description}
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {/* Date */}
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#5A554E] uppercase tracking-wide flex items-center gap-1">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            {/* Location Type */}
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#5A554E] uppercase tracking-wide">Location Type</label>
              <select
                value={locationType}
          ...
          <div className={`rounded-xl border p-4 transition-colors duration-300 ${preview.color}`}>
            ...
            <ul className="mt-2 pl-5 list-disc text-[11px] space-y-1 text-[#5A554E]">
