      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-900/60 via-slate-900 to-violet-950/40 p-6 sm:p-8 border border-white/5 shadow-xl">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-[#5A554E] max-w-xl">
              ...
              <button
                ...
                className={`rounded-lg px-2.5 py-1 font-semibold capitalize border transition-all ${
                  ownershipFilter === type
                    ...
                    : 'bg-transparent text-[#5A554E] border-transparent hover:text-slate-200'
                }`}
              >
                {type === 'all' ? 'All' : `${type}`}
              </button>
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-xs text-[#5A554E] line-clamp-2">
                      {event.description}
                    </p>
                  </div>
                  ...
                  <div className="mt-5 pt-4 border-t border-white/5 space-y-3">
                    <div className="flex flex-col gap-1.5 text-[11px] text-[#5A554E]">
                    ...
                    <div className="flex items-center justify-between text-xs pt-1">
                      <div className="flex items-center gap-3">
                        <span className="flex items-center gap-1 text-[#5A554E]" title="RSVPs">
                          <Users className="h-3.5 w-3.5 text-indigo-400" />
                          <strong className="text-slate-200 font-semibold">{event.attendees.length}</strong>
                        </span>
                        <span className="flex items-center gap-1 text-[#5A554E]" title="Interested">
            ...
            {filteredPromos.map((promo) => (
              ...
              >
                <div>
                  ...
                  <p className="mt-2 text-xs text-[#5A554E]">
                    {promo.description}
                  </p>
                </div>

                {/* Organizer details */}
                <div className="mt-5 pt-4 border-t border-white/5 flex flex-col gap-1.5 text-[11px] text-[#5A554E]">
                  <div>
