  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {createModalOpen && mounted && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center sm:p-4 p-0 bg-black/60 backdrop-blur-md animate-fade-in text-left">
          <AnimatePresence mode="wait">
            ...
            {onboardingStep === 1 && (
              <motion.div
                ...
                className="bg-white border border-black/[0.06] w-full sm:max-w-md rounded-none sm:rounded-[32px] p-7 shadow-2xl relative text-[#2A2621] flex flex-col justify-between h-full sm:h-[520px] cursor-pointer select-none overflow-y-auto"
              >
                <div className="flex justify-between items-center pb-2">
                  <span className="bg-[#FD5C05]/10 text-[#FD5C05] text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-[#FD5C05]/20 flex items-center gap-1.5">
                    <Sparkles className="h-3 w-3" /> Exclusive Feature
                  </span>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                    ...
                    className="h-8 w-8 rounded-full bg-black/[0.04] hover:bg-black/[0.08] flex items-center justify-center text-[#5A554E] hover:text-[#2A2621] transition-colors cursor-pointer border-none"
                    title="Close"
                  >
                    ✕
                  </button>
                ...
                <div className="space-y-4 my-auto">
                  <div className="space-y-1.5">
                    <h3 className="text-2xl font-black text-[#2A2621] tracking-tight leading-tight uppercase" style={{ fontFamily: 'var(--font-display)' }}>
                  ...
                  <div className="grid gap-2.5 pt-2">
                    {[
                      { Icon: Calendar, title: 'Create Campus Events', text: 'Host activities, track attendees, and publish to campus.' },
                      { Icon: Megaphone, title: 'Share Announcements', text: 'Reach all Livingstone students with updates and promos.' },
                      { Icon: Users, title: 'Recruit & Manage Roster', text: 'Manage club officers, rosters, and invitations easily.' },
                      { Icon: Sparkles, title: 'Official Verification', text: 'Gain an Official Verification Badge on Evida.' },
                    ].map((item, idx) => (
                      <div key={idx} className="bg-[#F8F6F0] border border-black/[0.04] rounded-2xl p-3 flex items-start gap-3 hover:border-[#FD5C05]/30 transition-all">
                        <div className="h-9 w-9 rounded-xl bg-[#FD5C05]/10 text-[#FD5C05] flex items-center justify-center shrink-0 mt-0.5">
                          <item.Icon className="h-4.5 w-4.5" />
                        </div>
                        <div className="min-w-0">
                          <h4 className="text-xs font-black text-[#2A2621] uppercase tracking-wide">{item.title}</h4>
                          <p className="text-[10.5px] text-[#5A554E] font-medium leading-snug">{item.text}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="flex flex-col items-center gap-3 pt-4 border-t border-black/[0.04]">
                  <div className="flex gap-1.5 justify-center">
                    <span className="h-1.5 w-6 bg-[#FD5C05] rounded-full transition-all" />
                    <span className="h-1.5 w-1.5 bg-black/10 rounded-full" />
                    <span className="h-1.5 w-1.5 bg-black/10 rounded-full" />
                  </div>
                  <button
                    onClick={(e) => {
                    ...
                    className="w-full py-3 rounded-full bg-[#2A2621] hover:bg-[#FD5C05] text-white text-xs font-black uppercase tracking-wider transition-all shadow-md cursor-pointer border-none flex items-center justify-center gap-2"
                  >
              ...
              >
                <div className="flex justify-between items-center pb-2">
                  <button
                    ...
                    className="text-xs font-black uppercase text-[#5A554E] hover:text-[#2A2621] transition-colors cursor-pointer border-none bg-transparent flex items-center gap-1"
                  >
                ...
                <div className="space-y-4 my-auto">
                  <div className="space-y-1.5">
                    <span className="bg-[#FD5C05]/10 text-[#FD5C05] text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-[#FD5C05]/20 inline-block">
                      Verification & Trust
                    </span>
                    <h3 className="text-2xl font-black text-[#2A2621] tracking-tight leading-tight uppercase" style={{ fontFamily: 'var(--font-display)' }}>
                  ...
                  <div className="relative p-4 bg-gradient-to-b from-[#FDFBF7] to-white border border-[#FD5C05]/20 rounded-2xl flex flex-col gap-3 shadow-xs text-left">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        <div className="h-8 w-8 rounded-xl bg-[#FD5C05] flex items-center justify-center text-xs font-black text-white shrink-0 shadow-xs">
                          BB
                        </div>
                        <div>
                          <div className="flex items-center gap-1">
                            <span className="font-extrabold text-xs text-[#2A2621]">Blue Bears Tech</span>
                            <span className="h-3.5 w-3.5 bg-[#FD5C05] text-white rounded-full flex items-center justify-center text-[7px] font-black shadow-xs" title="Verified Organization">✓</span>
                          </div>
                          <span className="text-[9px] text-[#5A554E] font-semibold uppercase tracking-wider block">@bluebearstech</span>
                        </div>
                      </div>
                      <span className="text-[8px] text-[#FD5C05] font-black uppercase tracking-wider bg-[#FD5C05]/10 px-2.5 py-1 rounded-lg border border-[#FD5C05]/20 shrink-0">
                        Official Group
                      </span>
                    </div>

                    <div className="border-t border-black/[0.04] pt-2.5 space-y-1.5">
                      <p className="font-bold text-xs text-[#2A2621] leading-snug">Join Livingstone College's Blue Bears Tech Club for our weekly campus workshop! 🎉</p>
                      <p className="text-[10px] text-[#5A554E] leading-normal font-medium">Building software, design systems, and campus events together.</p>
                      <div className="h-16 w-full rounded-xl bg-gradient-to-r from-[#2A2621] to-[#121212] flex flex-col items-center justify-center text-center p-2 relative overflow-hidden border border-black/10 mt-2">
                        <span className="text-[10px] font-extrabold text-white tracking-wide">Free Blue Bears Swag & Refreshments</span>
                        <span className="text-[8px] text-[#FD5C05] font-bold block mt-0.5 tracking-wider uppercase">Livingstone Student Center</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {onboardingStep === 3 && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -15, scale: 0.98 }}
                transition={{ duration: 0.2 }}
                className="bg-white border border-black/[0.06] w-full sm:max-w-md rounded-none sm:rounded-[32px] p-7 shadow-2xl relative text-[#2A2621] flex flex-col justify-between h-full sm:h-[520px] select-none overflow-y-auto"
              >
                <div className="flex justify-between items-center pb-2">
                  <button
                    onClick={() => setOnboardingStep(2)}
                ...
                <div className="space-y-4 my-auto text-left">
                  ...
                  <div className="space-y-3 pt-1">
                    {[
                      { step: '1', title: 'Belong to Livingstone College', text: 'Open to student clubs, departments, and campus initiatives.' },
                      { step: '2', title: 'Fast Admin Review', text: 'A campus administrator reviews your application in the queue.' },
                      { step: '3', title: 'Official Verification Badge', text: 'Once approved, start hosting verified campus events!' },
                    ].map((item, idx) => (
                      <div key={idx} className="bg-[#F8F6F0] border border-black/[0.04] rounded-2xl p-3.5 flex items-start gap-3.5">
                        <span className="h-7 w-7 rounded-xl bg-[#FD5C05] text-white flex items-center justify-center text-xs font-black shrink-0 mt-0.5 shadow-xs">
                          {item.step}
                        </span>
                        <div>
                          <h4 className="text-xs font-black text-[#2A2621] uppercase tracking-wide">{item.title}</h4>
                          <p className="text-[10.5px] text-[#5A554E] font-medium leading-relaxed mt-0.5">{item.text}</p>
                        </div>
                      </div>
                    ))}
                  </div>

                  <p className="text-[10px] text-[#5A554E] font-semibold italic leading-relaxed pt-1">
                ...
                <div className="flex flex-col items-center gap-3 pt-4 border-t border-black/[0.04]">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-full bg-gradient-to-r from-[#FD5C05] to-[#FC7C0B] hover:opacity-95 text-white text-xs font-black uppercase tracking-widest transition-all shadow-lg shadow-[#FD5C05]/20 active:scale-95 duration-150 cursor-pointer border-none flex items-center justify-center gap-2"
                  >
            ...
            {onboardingStep === 4 && (
              <motion.div
                ...
                className="bg-white border border-black/[0.06] w-full sm:max-w-md rounded-none sm:rounded-[32px] p-7 shadow-2xl relative text-[#2A2621] space-y-5 h-full sm:h-auto overflow-y-auto"
              >
                ...
                <div className="space-y-1 text-left">
                  <h3 className="text-xl font-black text-[#2A2621] uppercase tracking-tight" style={{ fontFamily: 'var(--font-display)' }}>
                    Create Org Profile
                  </h3>
                ...
                <form onSubmit={handleCreateOrg} className="space-y-4">
                  ...
                  <div className="pt-3 border-t border-black/[0.04] flex gap-3 justify-end items-center">
                    <button
                      type="button"
                      onClick={() => {
                        setCreateModalOpen(false);
                      ...
                      className="px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-[#5A554E] hover:text-[#2A2621] border-none bg-transparent cursor-pointer"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className="bg-gradient-to-r from-[#FD5C05] to-[#FC7C0B] text-white hover:opacity-95 px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-wider transition-all disabled:opacity-55 cursor-pointer border-none shadow-md shadow-[#FD5C05]/20"
                    >
