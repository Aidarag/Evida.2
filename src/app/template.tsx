...
export default function Template({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col bg-[#FFFDF8]">
      <AnimatePresence mode="wait">
        {showSplash ? (
          <motion.div
            ...
            className="fixed inset-0 z-55 flex flex-col items-center justify-center bg-[#FFFDF8]"
          >
            {/* Ambient Brand Glowing Blob */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#FF5A1F]/4 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="flex flex-col items-center gap-4 z-10">
              ...
              >
                <motion.div
                  ...
                  className="w-4 h-4 border-2 border-[#FF5A1F]/20 border-t-[#FF5A1F] rounded-full"
                />
              </motion.div>
            </div>
          </motion.div>
