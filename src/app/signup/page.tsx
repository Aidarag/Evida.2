                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-sm font-bold text-white uppercase tracking-wide">Student Registration</p>
                          <p className="text-xs text-[#B8BBC8] mt-0.5 max-w-[220px]">Register with your official school email and build your profile.</p>
                        </div>
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#B8BBC8] mt-0.5 max-w-[220px]">Establish Evida integration for your campus and departments.</p>
                        </div>
                      </div>
                  ...
                  <div className="pt-4 border-t border-white/[0.06] text-center">
                    <p className="text-xs text-[#B8BBC8]">
                      ...
                      <Link href="/login" className="text-[var(--color-evida-lime)] font-bold hover:underline transition-all">
                        Sign in here
                      </Link>
                    </p>
                  </div>
              ...
              {step === 'student-details' && (
                <form onSubmit={handleDetailsSubmit} className="space-y-4 pt-2">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border-2 border-white/[0.06] bg-white/[0.02] py-2.5 pl-11 pr-4 text-xs text-white placeholder-slate-600 focus:outline-none focus:border-[var(--color-evida-blue)] transition-all font-medium"
                        />
                      </div>
                    </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          <select
                            ...
                            className="w-full rounded-xl border-2 border-white/[0.06] bg-slate-950 py-2.5 pl-11 pr-4 text-xs text-white focus:outline-none focus:border-[var(--color-evida-blue)] transition-all font-medium cursor-pointer"
                          >
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-[var(--color-evida-blue)] hover:bg-[var(--color-evida-blue)]/90 py-3.5 text-xs font-bold text-[#08080B] uppercase tracking-widest transition-all hover:scale-[1.01] cursor-pointer disabled:opacity-50"
                  >
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border-2 border-white/[0.06] bg-white/[0.02] py-2.5 pl-11 pr-4 text-xs text-white placeholder-slate-600 focus:outline-none focus:border-[var(--color-evida-coral)] transition-all font-medium"
                        />
                      </div>
                    </div>
                ...
                <form onSubmit={handleVerifySubmit} className="space-y-5 pt-2">
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] text-[#B8BBC8] leading-relaxed">
                      We sent a code to <strong className="text-white">{email}</strong>. Enter it above to activate your Evida account.
                    </p>
                  </div>
